...
// task2 压缩包目录预览:zip / RAR4+RAR5 / 7z,以及双身份 zip 容器(jar/epub
// —— 无原生预览,默认即压缩包目录;task2 一补 iWork pages/numbers/key,同为 zip 容器)。
// docx/pptx 已移居 document handler(task2 二:默认文档渲染,"目录"由功能条 docMode 切换)。
// xlsx/xlsm/ods 保持 spreadsheet 路由,
...
export const archiveHandler: FormatHandler = {
  name: "archive",
  exts: ["zip", "rar", "7z", "jar", "epub", "pages", "numbers", "key"],
